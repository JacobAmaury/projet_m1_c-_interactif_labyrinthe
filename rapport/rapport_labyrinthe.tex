...
Dans ce projet, j'ai codé un labyrinthe interactif en C++. Le code creer un donjon, place le joueur à une entrée, puis on peut se déplacer dans la map. Mon objectif était de construire un projet structuré, lisible et suffisamment modulaire.
